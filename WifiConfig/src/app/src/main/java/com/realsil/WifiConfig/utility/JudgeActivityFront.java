...
public class JudgeActivityFront {
    ...
    public static boolean isApplicationBroughtToBackground(final Context context) {
        ...
        if (!tasks.isEmpty()) {
            ...
            ZLogger.d(D, "topActivity.getPackageName(): " + topActivity.getPackageName()
    ...
    public static boolean isAppOnForeground(final Context context) {
        ...
        if (appProcesses == null) {
            ZLogger.d(D, "appProcesses == null");
            return false;
        }
        for (ActivityManager.RunningAppProcessInfo appProcess : appProcesses) {
            ZLogger.d(D, "appProcess.processName = " + appProcess.processName
                    + ", context.getPackageName(): " + context.getPackageName()
